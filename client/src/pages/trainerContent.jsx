...
export function TrainerContent() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (editingId) {
            await axios.put("https://api.mylearningportal.site/api/protected/courses/" + editingId, course, { withCredentials: true });
            ...
            try {
                const res = await axios.post(
                    "https://api.mylearningportal.site/api/protected/courses/upload",
                    formData,
                    { withCredentials: true }
                );
                ...
                const updatedCourses = await axios.get(
                    "https://api.mylearningportal.site/api/protected/courses",
                    { withCredentials: true }
                );
    ...
    const handleRemoveCourse = async (courseId) => {
        ...
        try {
            await axios.delete("https://api.mylearningportal.site/api/protected/courses/" + courseId, { withCredentials: true });
    ...
    const handleEnroll = async (courseId) => {
        ...
        try {
            await axios.post(
                "https://api.mylearningportal.site/api/protected/enroll",
                { courseId },
                { withCredentials: true }
            );
